 ...
 */
// HASH define HAL_CPU_CLASS_16   1   // 16Mhz, AVR2560 or similar
// HASH define HAL_CPU_CLASS_75   2   // 75Mhz, Flymaple or similar
// HASH define HAL_CPU_CLASS_150  3   // 150Mhz, PX4 or similar, assumes
                               // hardware floating point. Assumes tens
                               // of kilobytes of memory available
// HASH define HAL_CPU_CLASS_1000 4   // GigaHz class, SITL, BeagleBone etc,
...
// HASH define HAL_CPU_CLASS HAL_CPU_CLASS_16
...
// HASH define HAL_CPU_CLASS HAL_CPU_CLASS_1000
// HASH define HAL_OS_POSIX_IO 1

#elif CONFIG_HAL_BOARD == HAL_BOARD_FLYMAPLE
#define AP_HAL_BOARD_DRIVER AP_HAL_FLYMAPLE
#define HAL_BOARD_NAME "FLYMAPLE"
// HASH define HAL_CPU_CLASS HAL_CPU_CLASS_75

#elif CONFIG_HAL_BOARD == HAL_BOARD_PX4
#define AP_HAL_BOARD_DRIVER AP_HAL_PX4
#define HAL_BOARD_NAME "PX4"
// HASH define HAL_CPU_CLASS HAL_CPU_CLASS_150
// HASH define HAL_OS_POSIX_IO 1

#elif CONFIG_HAL_BOARD == HAL_BOARD_LINUX
// HASH define AP_HAL_BOARD_DRIVER AP_HAL_Linux
