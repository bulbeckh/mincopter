...
#include "avrdx/UARTDriver.h"

using namespace AP_HAL_AVRDx;

#define FS_MAX_PORTS 4
// TODO These are globals?
AVRDxUARTDriver::Buffer __AVRUARTDriver__rxBuffer[FS_MAX_PORTS];
AVRDxUARTDriver::Buffer __AVRUARTDriver__txBuffer[FS_MAX_PORTS];

AVRDxUARTDriver::AVRDxUARTDriver(
...
void AVRDxUARTDriver::begin(uint32_t baud, uint16_t rxSpace, uint16_t txSpace) {
	return;
	// TODO
	/*
	uint16_t ubrr;
...
void AVRDxUARTDriver::flush(void) {
...
size_t AVRDxUARTDriver::write(uint8_t c) {
	return 0;
	// TODO
	/*
	uint8_t i;
...
size_t AVRDxUARTDriver::write(const uint8_t *buffer, size_t size)
{
	return 0;
	// TODO
	/*
...
// Buffer management ///////////////////////////////////////////////////////////
bool AVRDxUARTDriver::_allocBuffer(Buffer *buffer, uint16_t size)
{
	uint8_t mask;
	uint8_t	 shift;
...
void AVRDxUARTDriver::_freeBuffer(Buffer *buffer)
{
	buffer->head = buffer->tail = 0;
	buffer->mask = 0;
