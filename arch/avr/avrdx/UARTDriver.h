...
class AP_HAL_AVRDx::AVRDxUARTDriver : public AP_HAL::UARTDriver {
	public:
		AVRDxUARTDriver(
...
extern AP_HAL_AVRDx::AVRDxUARTDriver::Buffer __AVRUARTDriver__rxBuffer[];
extern AP_HAL_AVRDx::AVRDxUARTDriver::Buffer __AVRUARTDriver__txBuffer[];
