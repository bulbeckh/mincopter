...
void AVRDxRCOutput::init(void* machtnichts) {
	return;
	// TODO
	/*
...
void AVRDxRCOutput::set_freq(uint32_t chmask, uint16_t freq_hz)
{
	return;
	// TODO
	/*
...
uint16_t AVRDxRCOutput::get_freq(uint8_t ch)
{
	return 0;
	// TODO
	/*
    ...
    switch (ch) {
        ...
        case CH_8:
            icr = ICR3;
            break;
        // CH_10 and CH_11 share TIMER5 with input capture. The period is specified in OCR5A rater than the ICR.
        case CH_10:
        case CH_11:
            icr = OCR5A;
            break;
...
void AVRDxRCOutput::enable_ch(uint8_t ch) {
	return;
	// TODO
	/*
    switch(ch) {
...
void AVRDxRCOutput::disable_ch(uint8_t ch) {
	return;
	// TODO
	/*
    switch(ch) {
...
void AVRDxRCOutput::write(uint8_t ch, uint16_t period_us) {
...
void AVRDxRCOutput::write(uint8_t ch, uint16_t* period_us, uint8_t len) {
    for (int i = 0; i < len; i++) {
 ...
 * array of channels. */
uint16_t AVRDxRCOutput::read(uint8_t ch) {
	return 0;
	// TODO
	/*
    uint16_t pwm=0;
...
void AVRDxRCOutput::read(uint16_t* period_us, uint8_t len) {
    for (int i = 0; i < len; i++) {
        period_us[i] = read(i);
    }
}

uint16_t AVRDxRCOutput::_timer_period(uint16_t speed_hz) {
