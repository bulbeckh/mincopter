...
class Bmi270ImuDevice final : public ImuDevice {
public:
    Bmi270ImuDevice(mc_rtos_hal::I2cBus &i2c,
...
private:
    ...
    bool upload_configuration_blob();
    bool encode_sample_rate(uint32_t sample_rate_hz, uint8_t &acc_odr, uint8_t &gyr_odr) const;
    void delay_after_write();
