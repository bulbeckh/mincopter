...
void Log_Write_Current(void)
{
    ...
    struct log_Current pkt = {
        ...
        throttle_out        : 0, // mincopter.rc_3.servo_out,
...
// TODO Replace
void Log_Write_Performance(void)
{
...
{
	mincopter.DataFlash.LogReadProcess(log_num, start_page, end_page, NULL, mincopter.hal.console);
}
