...
def plot_inav(mc):
    ...
    ax.plot(range(0,len(mc.vel_x)), len(mc.vel_x)*[-2], color='red', linestyle='solid')
    ax.plot(range(0,len(mc.vel_x)), len(mc.vel_x)*[2], color='red', linestyle='solid')
    ...
    ax.plot(range(0,len(mc.vel_y)), len(mc.vel_y)*[-2], color='red', linestyle='solid')
    ax.plot(range(0,len(mc.vel_y)), len(mc.vel_y)*[2], color='red', linestyle='solid')
    ...
    ax.plot(range(0,len(mc.vel_z)), len(mc.vel_z)*[-2], color='red', linestyle='solid')
    ax.plot(range(0,len(mc.vel_z)), len(mc.vel_z)*[2], color='red', linestyle='solid')
