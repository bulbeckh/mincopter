...
def plot_mpc(mc):
    ...
    ax.set_title(f'Rotor0 Speed (-roll, +pitch) OR PWM (rad/s)')
    ax.set_xlim(pmin, pmax)
    ax.legend()
    ax.grid(True)
    ...
    ax.set_title(f'Rotor1 Speed (+roll, -pitch) OR PWM (rad/s)')
    ax.set_xlim(pmin, pmax)
    ax.legend()
    ax.grid(True)
    ...
    ax.set_title(f'Rotor2 Speed (-roll, -pitch) OR PWM (rad/s)')
    ax.set_xlim(pmin, pmax)
    ax.legend()
    ax.grid(True)
    ...
    ax.set_title(f'Rotor3 Speed (+roll, +pitch) OR PWM (rad/s)')
    ax.set_xlim(pmin, pmax)
    ax.legend()
    ax.grid(True)
